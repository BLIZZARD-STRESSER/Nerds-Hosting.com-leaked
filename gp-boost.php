            ...
            <div id="server_info_infor2">
                ...
                <div id="ftp_container">
                    <div id="ftp_header">
						...
						<h2 style="margin-left: 6%;margin-top: -5%;">Boost</h2>
                        <h3 style="font-size: 12px;margin-top: -1%;margin-left: 6%;">Ovde mozete bostovati vas server svakih 2 dana free!</h3>
                    ...
                    <div id="plugin_body">
                        <form id="form" action="process.php?task=boost_server" method="POST">
                            <input type="hidden" name="server_id" value="<?php echo $server_id; ?>" />
                                                        <a href="javascript:{}" onclick="document.getElementById('form').submit();"><div class="divbutton" style="margin-top:3%;float: right; margin-top: -60px;">BOOST</div></a>
                        </form>
                    </div>
                </div>
