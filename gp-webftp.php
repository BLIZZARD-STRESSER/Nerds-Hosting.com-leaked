...
<div class="space" style="margin-top: 20px;"></div>
                <div id="ftp_container">
                    <div id="ftp_header">
						...
						<h2 style="margin-left: 6%;margin-top: -5%;">WebFTP</h2>
                        <h3 style="font-size: 12px;margin-top: -1%;margin-left: 6%;">Direktan pristup fajlovima servera putem FTP protokola</h3>
                        <div class="space" style="margin-top: 60px;"></div>
                        </div>
                        <div id="right_header" style="float:right;">
                                <?php
                            ...
                            <a href="javascript:{}" onclick="document.getElementById('uploud').submit();"><div class="divbutton" style="float:right;">UPLOUD</div></a>
                                ...
                                ?>
                                <form id="folder" action="process.php?task=create_folder" method="POST">
                            ...
                            <a href="javascript:{}" onclick="document.getElementById('folder').submit();"><div class="divbutton" style="float:right;">NAPRAVI</div></a>
                                ...
                                ?>
                                <form id="wget" action="process.php?task=wget_file" method="POST">
                                    WGET file: <input type="text" name="wget_link" style="width: 215px;font-family: Tahoma, Verdana, Arial, sans-serif; font-weight: normal; font-size: 11px; line-height: 16px;  border: 1px solid #076ba6; color: #000;"> 
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="" method="POST" style="position: absolute;">
                                                        <a href="#">
                                                            <button id="iconweb"><i class="fa fa-edit"></i>EDIT</button>
                                                        </a>
                                                    </form>          
                                                </td>
                                            </tr>
                        ...
                        <?php } else { ?>
                            <div id="ftp_sacuvajFile">
                                ...
                                <form action="process.php?task=edit_file" method="POST">
                                    ...
                                    <input type="hidden" name="server_id" value="<?php echo $server_id; ?>" />
                                    <textarea style="height: 550px;background: transparent;color: orangered;" id="file_edit" name="file_text_edit" height="auto">
<?php echo $contents; ?>
                                    </textarea>
