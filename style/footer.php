            <div id="news">
                <div id="title">NOVOSTI</div>
                        ...
                        <a id="readmore" href="#"></a>
                                    ...
                                    <div id="news1">
                        <div id="title">Dođite na naš TS3 svaki klan dobija sobu TS.NERDS-HOSTING.COM!</div>
                        <a id="readmore" href="#"></a>
                    </div>
                                    <div id="news1">
                        <div id="title">PLAĆANJA SMS, PAYPAL, UPLATNICA, SKRILL, BTC</div>
                        <a id="readmore" href="#"></a>
                    </div>
                            </div>
            <div id="stats">
...
<div id="foter">
    <div id="copy">© 2019 by Nerds-Hosting.com
    </div>
