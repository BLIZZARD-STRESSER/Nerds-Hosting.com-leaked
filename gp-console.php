            ...
            <div id="server_info_infor2">
                ...
                <div id="ftp_container">
                    <div id="ftp_header">
						...
						<h2 style="margin-left: 6%;margin-top: -5%;">Konzola</h2>
                        <h3 style="font-size: 12px;margin-top: -1%;margin-left: 6%;">Ovde mozete slati komande koje ce biti izvrsene na serveru.</h3>
...
<pre style="width: 100%;height: 550px;background: none;color: #fff;overflow-y: scroll;color:orangered;">
    <?php
