...
if(!defined('DBNAME')) define("DBNAME", 'esbrsnfe_xiss');
if(!defined('DBUSER')) define("DBUSER", 'esbrsnfe_xiss'); 
if(!defined('DBPASS')) define("DBPASS", 'xiss123');
if(!defined('CHARSET')) define("CHARSET", '');
if(!defined('DOMEN')) define("DOMEN", 'http://nerds-hosting.com/');
