            ...
            <div id="server_info_infor2">
                <div id="ftp_container">
					 <div id="ftp_header">
						...
						<h2 style="margin-left: 6%;margin-top: -5%;">Autorestart</h2>
                        <h3 style="font-size: 12px;margin-top: -1%;margin-left: 6%;">Ovde mozete podesiti vreme kada zelite da vam se server automatski restartuje svaki dan</h3>
                        ...
                        <form id="form" action="process.php?task=auto_rs_edit" method="POST">
                            <input type="hidden" name="server_id" value="<?php echo $server['id']; ?>" />
                             <div id="select">
                            <select name="autorestart" style="width:250px;">
                            ...
                            <a href="javascript:{}" onclick="document.getElementById('form').submit();"><div class="divbutton" style="margin-top:3%;">SACUVAJ</div></a>
                        </form>
                </div>
            </div>
        </div>
